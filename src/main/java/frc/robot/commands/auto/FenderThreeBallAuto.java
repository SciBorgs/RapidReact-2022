...
public class FenderThreeBallAuto extends SequentialCommandGroup {
    public FenderThreeBallAuto(DriveSubsystem drive, IntakeSubsystem intake, HopperSubsystem hopper, ShooterSubsystem shooter, TurretSubsystem turret, String pos) {
        // Init intake
        addCommands(
            new InstantCommand(
                () -> intake.toggleArm(),
