...
/**
 * A simple vision subsystem to handle filtering our limelight values. Limelight networktable
 * methods are static so they can be used independently. Use an instance of VisionSubsystem for
 * filtering data. Require VisionSubsystem in any command that uses the filtered data from this
 * subsystem.
 */
